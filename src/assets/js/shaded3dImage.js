...
const textute1 = loader.load(backgrounds.shade1);
const textute2 = loader.load(backgrounds.shade2);
const textute3 = loader.load(backgrounds.shade3);
const textute4 = loader.load(backgrounds.shade4);
const textute5 = loader.load(backgrounds.shade5);
...
class Shaded {
  constructor() {
    ...
    this.links.map((link, i) => {
      link.addEventListener("mouseenter", () => {
        switch (i) {
          case 0:
            this.uniforms.uTexture.value = textute4;
            break;
          case 1:
            this.uniforms.uTexture.value = textute5;
            break;
          case 2:
            this.uniforms.uTexture.value = textute3;
            break;
          case 3:
            this.uniforms.uTexture.value = textute4;
            break;
  ...
  checkHovered() {
    ...
    this.inner.addEventListener("mouseleave", () => {
      this.hovered = false;
      this.uniforms.uTexture = { value: textute1 };
    });

    console.log(this.hovered);
  }
  setupCamera() {
    window.addEventListener("resize", this.onRsesize.bind(this));
    let fov =
  ...
  render() {
    ...
    this.uniforms.uOffset.value.set(
      (this.targetX-this.offset.y) * 0.0006,
